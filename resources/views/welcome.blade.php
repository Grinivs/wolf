            ...
            <div class="single-hero-slide">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-7">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="100ms">Keine Ahnung wie man <span>Bitcoins</span> kauft?</h2>
                                <h6 data-animation="fadeInUp" data-delay="400ms">Wir kaufen für dich schnell und einfach deinen gewünschten Coin.</h6>
                                <a href="#" class="btn cryptos-btn" data-animation="fadeInUp" data-delay="700ms">Mehr erfahren.</a>
                            </div>
                        </div>
                        <div class="col-12 col-md-5">
                            <div class="hero-slides-thumb" data-animation="fadeInUp" data-delay="1000ms">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-feature-area mb-100 text-center">
                        ...
                        <p>Die Arbeit machen wir! Innerhalb von 24h richten wir für Sie ein Konto ein und kaufen die gewünschten Kryptowährungen für Sie. Anschliessend bekommen Sie von uns die Login-Daten zugesendet. </p>
                        <a href="#" class="btn cryptos-btn">Mehr erfahren</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-feature-area mb-100 text-center">
                        ...
                        <p>Egal ob Anfänger, Fortgeschrittener oder Profi. Wir helfen allen. Sie benötigen keine Vorkenntnisse. Einfach Investieren. </p>
                        <a href="#" class="btn cryptos-btn">Mehr erfahren</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-feature-area mb-100 text-center">
                        ...
                        <h3>Tiefe Gebühren</h3>
                        <p>Schon für kleines Geld sind Sie dabei. Um alle Kosten zu decken berechnen wir 5% Transaktionsgebühr pro Transaktion. Das bedeutet z.B. bei einem Kauf/Verkauf in Wert von 100 CHF wird eine Gebühr 5%, also 5 CHF fällig.</p>
                        <a href="#" class="btn cryptos-btn">Mehr erfahren</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-feature-area mb-100 text-center">
                        ...
                        <h3>Sichere Aufbewahrung</h3>
                        <p>Wir arbeiten mit Sicheren und geprüften Plattformen zusammen um Ihnen die höchst mögliche Sicherheit bieten zu können.</p>
                        <a href="#" class="btn cryptos-btn">Mehr erfahren</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center white mx-auto">
                        <h3 class="mb-4">Kryptocurrency Rechner</h3>
                    ...
                    <div class="blog-area">
                        ...
                        <div class="single-blog-area d-flex align-items-start">
                            ...
                            <div class="blog-content">
                                ...
                                <div class="meta-data">
                                    <a href="post/{{ $post->slug }}">Crypto News</a> |
                                    <a href="post/{{ $post->slug }}">{{ $post->created_at }}</a>
                                </div>
                                <p>{{ $post->excerpt }}</p>
                            </div>
                        </div>
...
var cccTheme = {"Menu":{"background":"transparent"}};
(function (){
            ...
            <div class="row">
                <div class="col-12">
                    <div class="newsletter-area mt-100">
                        <div class="section-heading text-center mx-auto">
                            <h3>Für den <span>Newsletter</span> anmelden</h3>
                            <h6>Bleiben Sie stehts auf dem laufenden, un verpassen Sie keine Gelegenheit. Mit unserem Newsletter sind Sie immer top informiert.</h6>
                        </div>
                        <form action="#" method="post">
                            <input type="email" name="email" placeholder="Für den Newsletter anmelden">
